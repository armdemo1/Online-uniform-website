  ...
  <div class="row">
      <form  name="addproduct" action="product_form_edit_db.php" method="POST" enctype="multipart/form-data"  class="form-horizontal">
        <div class="form-group">
          <div class="col-sm-9">
            <p> Product Name</p>
            <input type="text"  name="p_name" class="form-control" required placeholder="Product Name" / value="<?php echo $p_name; ?>">
          </div>
        </div>
         <div class="form-group">
          <div class="col-sm-6">
        ...
        <div class="form-group">
          <div class="col-sm-12">
            ...
            <button type="submit" class="btn btn-success btn-sm" name="btnadd"> Save </button>
